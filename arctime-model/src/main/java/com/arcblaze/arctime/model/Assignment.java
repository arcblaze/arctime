...
/**
 * Represents an assignment of an employee to a contract.
 */
@XmlRootElement
...
public class Assignment implements Comparable<Assignment> {
	...
	/**
	 * The unique id of the contract to which the employee is assigned.
	 */
	...
	/**
	 * The labor category being used by the employee on the contract.
	 */
	...
	/**
	 * @return the unique id of the contract for which this assignment applies
	 */
	@XmlElement
	...
	/**
	 * @param contractId
	 *            the new unique id of the contract for which this assignment
	 *            applies
	 * 
	 * @return {@code this}
	 * 
	 ...
	 *             if the provided id value is invalid
	 */
	public Assignment setContractId(Integer contractId) {
		if (contractId == null)
