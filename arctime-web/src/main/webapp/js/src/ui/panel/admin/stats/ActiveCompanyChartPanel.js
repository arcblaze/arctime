...
ui.panel.admin.stats.ActiveCompanyChartPanel = Ext.extend(Ext.Panel, {
	constructor: function(c) {
				...
				new Ext.Panel({
					...
					listeners: {
						afterrender: function() {
							...
							var url = "/rest/admin/stats/companies"
		...
		ui.panel.admin.stats.ActiveCompanyChartPanel.superclass.constructor.call(this, config);
	}
});
